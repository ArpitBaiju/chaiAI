    ...
    return (
        ...
        result.db_entry.final_result === "AI Edited" ? "UNDER REVIEW" :
            "UPLOAD SUCCESSFUL"}
                    ...
                    <div className="text-left bg-black p-4 rounded text-sm font-mono text-gray-300 space-y-2">
    <p>
        <span className="text-gray-500">AI Generation Score:</span>{" "}
        {(result.db_entry.ai_generated_score * 100).toFixed(1)}%
    </p>

    <p>
        <span className="text-gray-500">Manipulation Score:</span>{" "}
        {(result.db_entry.manipulation_score * 100).toFixed(1)}%
    </p>

    <div className="pt-2 border-t border-gray-700">
        <p>
            <span className="text-gray-500">Forensic Summary:</span>{" "}
            {result.db_entry.forensic_summary}
        </p>
    </div>
</div>
